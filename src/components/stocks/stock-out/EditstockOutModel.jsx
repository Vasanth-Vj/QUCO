...
const EditStockOutModel = ({ show, onClose }) => {
    ...
    const [showCreateStockOutwardModal, setShowCreateStockOutwardModal] = useState(false);
            ...
            <div className="relative bg-white rounded-lg shadow-lg w-full max-w-[80vw] h-full max-h-[85vh] overflow-y-auto lg:overflow-hidden">
                <div className="p-10">
                    ...
                    <div className="flex justify-between w-full mt-5 border p-5 px-28">
                        ...
                        <div className="p-4 rounded-lg flex items-center justify-center whitespace-nowrap gap-5 mr-5">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <input type="number" className="block w-28 text-center border border-gray-300 shadow-sm px-4 py-1.5" />
                            </div>
                        </div>
                    ...
                    <div className="flex justify-end">
                        <button className="bg-sky-600 px-28 py-4 text-white mt-5 rounded-lg font-bold text-sm" onClick={handleCreateStockOutward}>Create Stock outward</button>
                    </div>
                </div>
            </div>
            {showCreateStockOutwardModal && (
                <StockSelectOptionModel onClose={() => setShowCreateStockOutwardModal(false)} />
            )}
        </div>
    );
};
