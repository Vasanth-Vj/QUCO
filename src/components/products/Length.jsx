...
const Length = ({ searchQuery, isModalOpen, onClose }) => {
  ...
  const filteredData = data.filter(item =>
    item.length.toLowerCase().includes(searchQuery.toLowerCase())
  ); 
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50 w-full">
            <tr>
              ...
              <th className="px-2 py-3 text-left text-md font-bold text-black uppercase w-40">length</th>
              ...
              <div className="flex flex-col items-center">
                ...
                {addedStyles.length > 0 ? (
                  <div className="flex flex-wrap mt-3">
                    ...
                    <span className="text-gray-500 text-xl">No length entries</span>
                  </div>
                )}
                </div>
              </div>
