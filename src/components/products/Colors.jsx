...
const Colors = ({ searchQuery, isModalOpen, onClose }) => {
  const [data, setData] = useState([
    { id: 1, colors: 'black', status: 'active' },
    { id: 2, colors: 'blue', status: 'inactive' },
    { id: 3, colors: 'Yellow', status: 'active' },
    { id: 4, colors: 'Red', status: 'inactive' },
    { id: 5, colors: 'Jersey', status: 'active' },
    { id: 6, colors: 'Jersey', status: 'inactive' },
    { id: 7, colors: 'Jersey', status: 'active' },
    { id: 8, colors: 'Jersey', status: 'inactive' },
    { id: 9, colors: 'Jersey', status: 'active' },
    { id: 10, colors: 'Jersey', status: 'inactive' },
    { id: 11, colors: 'Jersey', status: 'active' },
    { id: 12, colors: 'Jersey', status: 'inactive' },
  ]);
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50 w-full">
            <tr>
              ...
              <th className="px-2 py-3 text-center text-md font-bold text-black uppercase w-40">Colors</th>
          ...
          <div className="relative bg-white rounded-lg shadow-lg w-full max-w-[35vw] h-screen max-h-[50vh] overflow-y-auto lg:overflow-hidden">
            <div className="py-2 flex flex-col">
              ...
              <div className="flex flex-col items-center">
                <p className="text-gray-400 font-bold mt-10">*For multiple “Colours” feed use enter after each values</p>
                <input
                ...
                {addedStyles.length > 0 ? (
                  <div className="flex flex-wrap mt-3">
                    ...
                    <span className="text-gray-500 text-xl">No colors entries</span>
                  </div>
                )}
                </div>
              </div>
