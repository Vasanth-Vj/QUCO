...
const KnitType = ({ searchQuery, isModalOpen, onClose }) => {
  const [data, setData] = useState([
    { id: 1, knitType: 'Jersey', status: 'active' },
    { id: 2, knitType: 'Jersey', status: 'inactive' },
    { id: 3, knitType: 'Jersey', status: 'active' },
    { id: 4, knitType: 'Jersey', status: 'inactive' },
    { id: 5, knitType: 'Jersey', status: 'active' },
    { id: 6, knitType: 'Jersey', status: 'inactive' },
    { id: 7, knitType: 'Jersey', status: 'active' },
    { id: 8, knitType: 'Jersey', status: 'inactive' },
    { id: 9, knitType: 'Jersey', status: 'active' },
    { id: 10, knitType: 'Jersey', status: 'inactive' },
    { id: 11, knitType: 'Jersey', status: 'active' },
    { id: 12, knitType: 'Jersey', status: 'inactive' },
  ]);
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50 w-full">
            <tr>
              ...
              <th className="px-2 py-3 text-center text-md font-bold text-black uppercase w-40">Knit Type</th>
          ...
          <div className="relative bg-white rounded-lg shadow-lg w-full max-w-[35vw] h-screen max-h-[50vh] overflow-y-auto lg:overflow-hidden">
            <div className="py-2 flex flex-col">
              ...
              <div className="flex flex-col items-center">
                <p className="text-gray-400 font-bold mt-10">*For multiple “Knit type” feed use enter after each values</p>
                <input
                ...
                {addedStyles.length > 0 ? (
                  <div className="flex flex-wrap mt-3">
                    ...
                    <span className="text-gray-500 text-xl">No knit type entries</span>
                  </div>
                )}
                </div>
              </div>
