...
const Neck = ({ searchQuery, isModalOpen, onClose }) => {
  ...
  const handleInputChange = (e, index) => {
    const newData = [...data];
    newData[index].neck = e.target.value;
    setData(newData);
  };
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50 w-full">
            <tr>
              ...
              <th className="px-2 py-3 text-left text-md font-bold text-black uppercase w-40">Neck</th>
          ...
          <div className="relative bg-white rounded-lg shadow-lg w-full max-w-[35vw] h-screen max-h-[50vh] overflow-y-auto lg:overflow-hidden">
            <div className="py-2 flex flex-col">
              ...
              <div className="flex flex-col items-center">
                <p className="text-gray-400 font-bold mt-10">*For multiple “Neck ” feed use enter after each values</p>
                <input
