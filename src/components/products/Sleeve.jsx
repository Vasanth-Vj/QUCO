...
const Sleeve = ({ searchQuery, isModalOpen, onClose }) => {
  ...
  const filteredData = data.filter(item =>
    item.sleeve.toLowerCase().includes(searchQuery.toLowerCase())
  ); 
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50 w-full">
            <tr>
              ...
              <th className="px-2 py-3 text-left text-md font-bold text-black uppercase w-40">sleeve</th>
          ...
          <div className="relative bg-white rounded-lg shadow-lg w-full max-w-[35vw] h-screen max-h-[50vh] overflow-y-auto lg:overflow-hidden">
            <div className="py-2 flex flex-col">
              ...
              <div className="flex flex-col items-center">
                <p className="text-gray-400 font-bold mt-10">*For multiple “Sleeve” feed use enter after each values</p>
                <input
                ...
                {addedStyles.length > 0 ? (
                  <div className="flex flex-wrap mt-3">
                    ...
                    <span className="text-gray-500 text-xl">No sleeve entries</span>
                  </div>
                )}
                </div>
              </div>
