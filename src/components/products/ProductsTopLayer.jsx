...
const ProductsTopLayer = ({
  ...
  const presets = [
    ...
    { id: 'pr2', value: '2', label: 'Reference No', component: RefNo },
    ...
    { id: 'pr11', value: '11', label: 'Print Or emb name', component: PrintOrEmb },
    { id: 'pr12', value: '12', label: 'Short description', component: ShortDescription },
    { id: 'pr13', value: '13', label: 'Full description', component: FullDescription },
    { id: 'pr14', value: '14', label: 'Stitch details', component: StitchDetails },
    { id: 'pr15', value: '15', label: 'Chest dla', component: chestDla },
    { id: 'pr16', value: '16', label: 'Neck', component: Neck },
    { id: 'pr17', value: '17', label: 'Sleeve', component: Sleeve },
    { id: 'pr18', value: '18', label: 'Length', component: Length },
    { id: 'pr19', value: '19', label: 'Measurement chart', component: MeasurementChart },
    { id: 'pr20', value: '20', label: 'Packing method', component: PackingMethod },
    { id: 'pr21', value: '21', label: 'No of pieces per inner', component: PiecesPerInner },
    { id: 'pr22', value: '22', label: 'No of pieces per outer carton', component: PiecesPerCarton },
  ];
    ...
    if (!selectedPreset) {
      return (
        <div className="flex justify-center items-center min-h-[60vh]">
          ...
          <img src={noDataImage} alt="No Data" className="flex flex-grow object-cover max-w-[600px]" />
          <span className='mt-4 text-black font-bold text-2xl' >Select product category to show data</span>
          </div>
        </div>
      );
    }
    const selectedCategory = presets.find((preset) => preset.value === selectedPreset);
    return selectedCategory ? <selectedCategory.component searchQuery={searchQuery} isModalOpen={isModalOpen} onClose={onClose} /> : null;
  };
  

  const addButtonLabel = () => {
    if (selectedPreset) {
      const selectedPresetObj = presets.find((preset) => preset.value === selectedPreset);
    ...
    <div>
      ...
      {showDropdown && (
          <div className="relative mr-4">
            ...
            >
              <span className="hover:underline flex items-center" title="Nav Link 2">
                {getCategoryText()}
              </span>
      ...
      {showSearch && (
          <div className="flex-grow mx-4 flex justify-center items-center">
            <div className="relative">
              <img src={searchIcon} alt="Search Icon" className="absolute left-3 w-4 h-4 mt-3" />
              <input
                type="text"
                placeholder="Search..."
        ...
        {showAddButton && (
          <div className="ml-4">
            <button className="font-bold px-4 py-2 rounded-lg flex" onClick={openModal}>
