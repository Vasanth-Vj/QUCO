...
const PrintOrEmb = ({ searchQuery, isModalOpen, onClose }) => {
  const [data, setData] = useState([
    { id: 1, printOrEmb: 'HD Print', status: 'active' },
    { id: 2, printOrEmb: 'Front AOP', status: 'inactive' },
    { id: 3, printOrEmb: 'Back AOP', status: 'active' },
    { id: 4, printOrEmb: 'SD Print', status: 'inactive' },
    { id: 5, printOrEmb: 'Pencil Fit', status: 'active' },
    { id: 6, printOrEmb: 'Jersey', status: 'inactive' },
    { id: 7, printOrEmb: 'Jersey', status: 'active' },
    { id: 8, printOrEmb: 'Jersey', status: 'inactive' },
    { id: 9, printOrEmb: 'Jersey', status: 'active' },
    { id: 10, printOrEmb: 'Jersey', status: 'inactive' },
    { id: 11, printOrEmb: 'Jersey', status: 'active' },
    { id: 12, printOrEmb: 'Jersey', status: 'inactive' },
  ]);
  ...
  const filteredData = data.filter(item =>
    item.printOrEmb.toLowerCase().includes(searchQuery.toLowerCase())
  ); 
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50 w-full">
            <tr>
              ...
              <th className="px-2 py-3 text-center text-md font-bold text-black uppercase w-40">printOrEmb</th>
          ...
          <div className="relative bg-white rounded-lg shadow-lg w-full max-w-[35vw] h-screen max-h-[50vh] overflow-y-auto lg:overflow-hidden">
            <div className="py-2 flex flex-col">
              ...
              <div className="flex flex-col items-center">
                <p className="text-gray-400 font-bold mt-10">*For multiple “Print” feed use enter after each values</p>
                <input
                ...
                {addedStyles.length > 0 ? (
                  <div className="flex flex-wrap mt-3">
                    ...
                    <span className="text-gray-500 text-xl">No print or emb entries</span>
                  </div>
                )}
                </div>
              </div>
