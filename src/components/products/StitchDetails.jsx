...
const StitchDetails = ({ searchQuery, isModalOpen, onClose }) => {
  const [data, setData] = useState([
    { id: 1, stitchDetails: 'Tuber', status: 'active' },
    { id: 2, stitchDetails: 'Slide Screen', status: 'inactive' },
    { id: 3, stitchDetails: 'Left Tight', status: 'active' },
    { id: 4, stitchDetails: 'Lorem', status: 'inactive' },
    { id: 5, stitchDetails: 'Ipsum', status: 'active' },
    { id: 6, stitchDetails: 'Jersey', status: 'inactive' },
    { id: 7, stitchDetails: 'Jersey', status: 'active' },
    { id: 8, stitchDetails: 'Jersey', status: 'inactive' },
    { id: 9, stitchDetails: 'Jersey', status: 'active' },
    { id: 10, stitchDetails: 'Jersey', status: 'inactive' },
    { id: 11, stitchDetails: 'Jersey', status: 'active' },
    { id: 12, stitchDetails: 'Jersey', status: 'inactive' },
  ]);
  ...
  const filteredData = data.filter(item =>
    item.stitchDetails.toLowerCase().includes(searchQuery.toLowerCase())
  ); 
  ...
  const handleInputChange = (e, index) => {
    const newData = [...data];
    newData[index].stitchDetails = e.target.value;
    setData(newData);
  };
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50 w-full">
            <tr>
              ...
              <th className="px-2 py-3 text-center text-md font-bold text-black uppercase w-60">Stitch Details</th>
          ...
          <div className="relative bg-white rounded-lg shadow-lg w-full max-w-[35vw] h-screen max-h-[50vh] overflow-y-auto lg:overflow-hidden">
            <div className="py-2 flex flex-col">
              ...
              <div className="flex flex-col items-center">
                <p className="text-gray-400 font-bold mt-10">*For multiple “Stitch Details” feed use enter after each values</p>
                <input
                ...
                {addedStyles.length > 0 ? (
                  <div className="flex flex-wrap mt-3">
                    ...
                    <span className="text-gray-500 text-xl">No stich details entries</span>
                  </div>
                )}
                </div>
              </div>
