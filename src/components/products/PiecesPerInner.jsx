...
const PiecesPerInner = ({ searchQuery, isModalOpen, onClose }) => {
  const [data, setData] = useState([
    { id: 1, piecesPerInner: 'Short length', status: 'active' },
    { id: 2, piecesPerInner: 'medium length', status: 'inactive' },
    { id: 3, piecesPerInner: 'Full length', status: 'active' },
    { id: 4, piecesPerInner: 'cut', status: 'inactive' },
    { id: 5, piecesPerInner: 'loose', status: 'active' },
    { id: 6, piecesPerInner: 'Jersey', status: 'inactive' },
    { id: 7, piecesPerInner: 'Jersey', status: 'active' },
    { id: 8, piecesPerInner: 'Jersey', status: 'inactive' },
    { id: 9, piecesPerInner: 'Jersey', status: 'active' },
    { id: 10, piecesPerInner: 'Jersey', status: 'inactive' },
    { id: 11, piecesPerInner: 'Jersey', status: 'active' },
    { id: 12, piecesPerInner: 'Jersey', status: 'inactive' },
  ]);
  ...
  const filteredData = data.filter(item =>
    item.piecesPerInner.toLowerCase().includes(searchQuery.toLowerCase())
  ); 
  ...
  const handleInputChange = (e, index) => {
    const newData = [...data];
    newData[index].piecesPerInner = e.target.value;
    setData(newData);
  };
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50 w-full">
            <tr>
              ...
              <th className="px-2 py-3 text-left text-md font-bold text-black 2xl:w-[500px] xl:w-[450px] min-w-[200px]">No of pcs per inner</th>
          ...
          <div className="relative bg-white rounded-lg shadow-lg w-full max-w-[35vw] h-screen max-h-[50vh] overflow-y-auto lg:overflow-hidden">
            <div className="py-2 flex flex-col">
              ...
              <div className="flex flex-col items-center">
                <p className="text-gray-400 font-bold mt-10">*For multiple “Pcs Per Inner” feed use enter after each values</p>
                <input
                ...
                {addedStyles.length > 0 ? (
                  <div className="flex flex-wrap mt-3">
                    ...
                    <span className="text-gray-500 text-xl">No inner entries</span>
                  </div>
                )}
                </div>
              </div>
