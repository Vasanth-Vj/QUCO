...
const ShortDescription = ({ searchQuery, isModalOpen, onClose }) => {
  const [data, setData] = useState([
    { id: 1, shortDescription: 'HD Print', status: 'active' },
    { id: 2, shortDescription: 'Front AOP', status: 'inactive' },
    { id: 3, shortDescription: 'Back AOP', status: 'active' },
    { id: 4, shortDescription: 'SD Print', status: 'inactive' },
    { id: 5, shortDescription: 'Pencil Fit', status: 'active' },
    { id: 6, shortDescription: 'Jersey', status: 'inactive' },
    { id: 7, shortDescription: 'Jersey', status: 'active' },
    { id: 8, shortDescription: 'Jersey', status: 'inactive' },
    { id: 9, shortDescription: 'Jersey', status: 'active' },
    { id: 10, shortDescription: 'Jersey', status: 'inactive' },
    { id: 11, shortDescription: 'Jersey', status: 'active' },
    { id: 12, shortDescription: 'Jersey', status: 'inactive' },
  ]);
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50 w-full">
            <tr>
              ...
              <th className="px-2 py-3 text-left text-md font-bold text-black uppercase w-60">Short Description</th>
          ...
          <div className="relative bg-white rounded-lg shadow-lg w-full max-w-[35vw] h-screen max-h-[50vh] overflow-y-auto lg:overflow-hidden">
            <div className="py-2 flex flex-col">
              ...
              <div className="flex flex-col items-center">
                <p className="text-gray-400 font-bold mt-10">*For multiple “Short description” feed use enter after each values</p>
                <textarea
